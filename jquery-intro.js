...
$(document).ready(function() {
  ...
  var specials_text = specials[date.getMonth()];
  if (month_name == "December") {
    $("#slogan").after("<h3>Happy Holidays!</h3>");
  }
  $("#month").text(month_name + " Tips");
  $("#copy").append(" " + year);
  $("#specials").html(specials_text);
  switch(month_num) {
    case 11: case 0: case 1:
      season = "Winter"
      background_image = 'winterbg.jpg'
      season_color = "#00f"
      season_index = 0
      break;
    case 2: case 3: case 4:
      season = "Spring"
      background_image = 'springbg.jpg'
      season_color = "#d7d"
      season_index = 1
      break;
    case 5: case 6: case 7:
      season = "Summer"
      background_image = 'summerbg.jpg'
      season_color = "#006400"
      season_index = 2
      break;
    case 8: case 9: case 10:
      season = "Fall"
      background_image = 'fallbg.jpg'
      season_color = "#930"
      season_index = 3
      break;
  }
  ...
  $("#seasontips").html(tips[season_index]);
  $("#specials").addClass(season);
  $("strong, h1, h2, h3").css("color", season_color);
});